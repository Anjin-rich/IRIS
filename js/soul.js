...
(function () {
    ...
    var ORACLE_CARDS = [
        // 破晓 DAWN
        { id: 1, theme: 'dawn', num: 'Ⅰ', name_zh: '初光', name_en: 'FIRST LIGHT', keywords: ['起跑点','临界突破','微明'], meaning: '最难的从来不是路途，\n而是起跑前那一秒的静止。', action: '做一件拖了三天的小事', icon: '<circle cx="20" cy="22" r="8" stroke="#e89866" stroke-width="1.5"/><path d="M20 8 L20 12 M8 22 L12 22 M28 22 L32 22 M11 13 L14 16 M26 13 L23 16" stroke="#e89866" stroke-width="1.5" stroke-linecap="round"/>' },
        { id: 2, theme: 'dawn', num: 'Ⅱ', name_zh: '启程', name_en: 'DEPARTURE', keywords: ['方向切换','整装','前瞻'], meaning: '不必等待风平浪静，\n带上海浪的方向即可出发。', action: '列一件"等条件成熟"的事，今天就起个头', icon: '<path d="M20 28 L20 12 M14 18 L20 12 L26 18" stroke="#e89866" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/><circle cx="20" cy="30" r="2" fill="#e89866"/>' },
        { id: 3, theme: 'dawn', num: 'Ⅲ', name_zh: '破壳', name_en: 'HATCHING', keywords: ['界限突破','张力','蜕变'], meaning: '旧壳破裂，\n恰是生命向外生长的信号。', action: '写下一件你"已经不一样"的事', icon: '<path d="M20 10 Q24 10, 24 14 Q28 14, 28 18 Q28 22, 24 22 L16 22 Q12 22, 12 18 Q12 14, 16 14 Q16 10, 20 10 Z" stroke="#e89866" stroke-width="1.5"/><path d="M20 22 L20 30" stroke="#e89866" stroke-width="1.5"/>' },
        { id: 4, theme: 'dawn', num: 'Ⅳ', name_zh: '唤醒', name_en: 'AWAKENING', keywords: ['觉察','内在点亮','清明'], meaning: '内在灯火一直都在，\n只需一次轻轻的点亮。', action: '回忆一件让你眼睛发亮的事', icon: '<path d="M8 30 Q14 22, 20 22 Q26 22, 32 30" stroke="#e89866" stroke-width="1.5"/><circle cx="20" cy="16" r="4" fill="rgba(232,152,102,0.3)" stroke="#e89866" stroke-width="1.5"/>' },
        { id: 5, theme: 'dawn', num: 'Ⅴ', name_zh: '攀登', name_en: 'ASCENT', keywords: ['积累','高度','韧性'], meaning: '山峰从不降低，\n但踩实的每一步都在向上。', action: '为一项长期目标做 10 分钟', icon: '<path d="M12 24 L20 12 L28 24" stroke="#e89866" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/><path d="M12 24 L28 24" stroke="#e89866" stroke-width="1.5"/><circle cx="20" cy="18" r="1.5" fill="#e89866"/>' },
        { id: 6, theme: 'dawn', num: 'Ⅵ', name_zh: '前路', name_en: 'PATH AHEAD', keywords: ['未知','迷雾','探索'], meaning: '道路无需提前看清，\n会在脚步落下时自动展开。', action: '走一条没走过的回家路', icon: '<path d="M8 20 L32 20 M22 10 L32 20 L22 30" stroke="#e89866" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>' },
        { id: 7, theme: 'dawn', num: 'Ⅶ', name_zh: '仰望', name_en: 'LOOK UP', keywords: ['视角转换','辽阔','超脱'], meaning: '低头太久，\n云层流动里藏着辽阔解法。', action: '出门抬头看一次云', icon: '<path d="M10 20 Q10 10, 20 10 Q30 10, 30 20" stroke="#e89866" stroke-width="1.5"/><path d="M14 20 L20 14 L26 20" stroke="#e89866" stroke-width="1.5" stroke-linecap="round"/>' },
        { id: 8, theme: 'dawn', num: 'Ⅷ', name_zh: '跃迁', name_en: 'LEAP', keywords: ['非线性变化','抉择','临界点'], meaning: '许多转变并非渐进，\n而发生于果断的一瞬。', action: '做一个想了很久的小决定', icon: '<path d="M14 14 L26 26 M26 14 L14 26" stroke="#e89866" stroke-width="1.5" stroke-linecap="round"/><circle cx="20" cy="20" r="10" stroke="#e89866" stroke-width="1" stroke-dasharray="2 3"/>' },
        { id: 9, theme: 'dawn', num: 'Ⅸ', name_zh: '初心', name_en: 'BEGINNER', keywords: ['原点','纯粹','未被塑造'], meaning: '起点处的纯粹渴望，\n始终保留在故事最深处。', action: '翻出一件"最初的物品"看看', icon: '<path d="M20 8 L23 16 L31 16 L25 21 L27 29 L20 24 L13 29 L15 21 L9 16 L17 16 Z" stroke="#e89866" stroke-width="1.5" stroke-linejoin="round"/>' },
        // 盛光 LIGHT
        { id: 10, theme: 'light', num: 'Ⅰ', name_zh: '盛光', name_en: 'FULL LIGHT', keywords: ['全貌显现','无所隐藏','表达'], meaning: '日光倾泻，\n万物坦然展露属于自己的轮廓。', action: '分享一件你擅长的小事', icon: '<circle cx="20" cy="20" r="6" fill="rgba(232,201,106,0.4)" stroke="#c9a83a" stroke-width="1.5"/><path d="M20 6 L20 10 M20 30 L20 34 M6 20 L10 20 M30 20 L34 20 M10 10 L13 13 M27 27 L30 30 M30 10 L27 13 M10 30 L13 27" stroke="#c9a83a" stroke-width="1.5" stroke-linecap="round"/>' },
        { id: 11, theme: 'light', num: 'Ⅱ', name_zh: '聚焦', name_en: 'FOCUS', keywords: ['收束','能量汇聚','透镜'], meaning: '散落光线透过透镜，\n方能聚合成穿透的力量。', action: '25 分钟只做一件事', icon: '<circle cx="20" cy="20" r="12" stroke="#c9a83a" stroke-width="1.5"/><circle cx="20" cy="20" r="4" fill="#c9a83a"/>' },
        { id: 12, theme: 'light', num: 'Ⅲ', name_zh: '锚点', name_en: 'ANCHOR', keywords: ['核心不动','秩序','定海神针'], meaning: '水流湍急，\n底层的沉石守着整片流域的秩序。', action: '写下今天不会变的三件事', icon: '<path d="M20 8 L32 20 L20 32 L8 20 Z" stroke="#c9a83a" stroke-width="1.5" stroke-linejoin="round"/><path d="M14 20 L26 20 M20 14 L20 26" stroke="#c9a83a" stroke-width="1.5"/>' },
        { id: 13, theme: 'light', num: 'Ⅳ', name_zh: '落定', name_en: 'SETTLED', keywords: ['悬念终结','尘埃落定','确定性'], meaning: '悬浮尘埃终止漂泊，\n落地即是全新支撑。', action: '完成一件悬而未决的事', icon: '<path d="M8 20 L16 28 L32 12" stroke="#c9a83a" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>' },
        { id: 14, theme: 'light', num: 'Ⅴ', name_zh: '建造', name_en: 'BUILD', keywords: ['结构','基石','时间复利'], meaning: '宏伟建筑不凭空想，\n全靠一砖一瓦扎实砌叠。', action: '为一个目标添一块"砖"', icon: '<path d="M10 30 L10 14 L20 8 L30 14 L30 30" stroke="#c9a83a" stroke-width="1.5" stroke-linejoin="round"/><path d="M16 30 L16 22 L24 22 L24 30" stroke="#c9a83a" stroke-width="1.5"/>' },
        { id: 15, theme: 'light', num: 'Ⅵ', name_zh: '清朗', name_en: 'CLARITY', keywords: ['洞察','穿透','无障碍'], meaning: '迷雾散去，\n远方轮廓比预想更分明。', action: '写下一个突然想明白的事', icon: '<path d="M20 6 L20 34 M6 20 L34 20" stroke="#c9a83a" stroke-width="1.5"/><circle cx="20" cy="20" r="10" stroke="#c9a83a" stroke-width="1" stroke-dasharray="3 2"/>' },
        { id: 16, theme: 'light', num: 'Ⅶ', name_zh: '显化', name_en: 'MANIFEST', keywords: ['从无到有','物质化','落地'], meaning: '沉淀许久的念头，\n开始在现实里刻下痕迹。', action: '为想要的事做一件准备', icon: '<circle cx="20" cy="20" r="12" stroke="#c9a83a" stroke-width="1.5"/><path d="M20 8 A12 12 0 0 1 32 20 L20 20 Z" fill="rgba(232,201,106,0.4)"/>' },
        { id: 17, theme: 'light', num: 'Ⅷ', name_zh: '绽放', name_en: 'BLOOM', keywords: ['完全展开','生命力','盛开'], meaning: '漫长蓄力之后，\n花瓣舒展是自然的盛大表达。', action: '发布/展示一件你的作品', icon: '<path d="M20 6 L24 16 L34 16 L26 22 L29 32 L20 26 L11 32 L14 22 L6 16 L16 16 Z" stroke="#c9a83a" stroke-width="1.5" stroke-linejoin="round" fill="rgba(232,201,106,0.2)"/>' },
        { id: 18, theme: 'light', num: 'Ⅸ', name_zh: '硕果', name_en: 'HARVEST', keywords: ['反馈','因果','收成'], meaning: '无声耕耘的种子，\n终将在季节里迎来沉甸甸的回应。', action: '感谢一件过去的努力', icon: '<path d="M8 32 L8 24 M16 32 L16 18 M24 32 L24 12 M32 32 L32 20" stroke="#c9a83a" stroke-width="2" stroke-linecap="round"/>' },
        // 暮影 DUSK
        ...
        { id: 20, theme: 'dusk', num: 'Ⅱ', name_zh: '沉淀', name_en: 'SETTLE', keywords: ['澄清','重力作用','下沉'], meaning: '受搅动的水流不用外力，\n静置就是最好的澄清。', action: '安静坐 5 分钟，什么都不做', icon: '<path d="M20 8 Q28 8, 28 16 Q28 24, 20 28 Q12 24, 12 16 Q12 8, 20 8 Z" stroke="#9c6e9a" stroke-width="1.5"/><path d="M20 28 L20 34" stroke="#9c6e9a" stroke-width="1.5"/>' },
        { id: 21, theme: 'dusk', num: 'Ⅲ', name_zh: '释放', name_en: 'RELEASE', keywords: ['主动解扣','松开','原谅'], meaning: '紧握的手掌无法拥抱风，\n松开瞬间即是自由。', action: '写下一件想放下的事，撕掉', icon: '<path d="M20 6 L20 22 M14 12 L20 6 L26 12" stroke="#9c6e9a" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/><path d="M10 30 L30 30" stroke="#9c6e9a" stroke-width="1.5"/><path d="M12 30 Q12 24, 20 24 Q28 24, 28 30" stroke="#9c6e9a" stroke-width="1.5"/>' },
        { id: 22, theme: 'dusk', num: 'Ⅳ', name_zh: '流转', name_en: 'FLOW', keywords: ['动态平衡','周期','不卡顿'], meaning: '事物始终处于流动中，\n看似停滞也是蓄势节律。', action: '观察一件正在变化的事', icon: '<path d="M10 14 L20 24 L30 14" stroke="#9c6e9a" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/><path d="M10 24 L20 34 L30 24" stroke="#9c6e9a" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>' },
        { id: 23, theme: 'dusk', num: 'Ⅴ', name_zh: '蜕变', name_en: 'SHED', keywords: ['旧壳剥离','新生重构','换羽'], meaning: '外壳剥离带着撕裂感，\n却是新羽舒展的前奏。', action: '改掉一个小习惯一天', icon: '<circle cx="20" cy="20" r="6" fill="rgba(156,110,154,0.3)" stroke="#9c6e9a" stroke-width="1.5"/><path d="M14 14 L26 26 M26 14 L14 26" stroke="#9c6e9a" stroke-width="1" stroke-dasharray="2 2"/>' },
        { id: 24, theme: 'dusk', num: 'Ⅵ', name_zh: '归途', name_en: 'RETURN', keywords: ['回溯','本源','收拢'], meaning: '向外远行之后，\n回溯原点也是勇敢的前进。', action: '联系一个"老地方"的人', icon: '<path d="M12 20 L20 28 L28 20" stroke="#9c6e9a" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/><path d="M12 12 L20 20 L28 12" stroke="#9c6e9a" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>' },
        ...
        { id: 26, theme: 'dusk', num: 'Ⅷ', name_zh: '柔光', name_en: 'SOFT GLOW', keywords: ['去锋芒','温和','非竞争'], meaning: '无须时刻保持耀眼，\n温和微光同样抚慰人心。', action: '允许自己今天"差不多就行"', icon: '<path d="M20 10 L28 18 L20 26 L12 18 Z" stroke="#9c6e9a" stroke-width="1.5" stroke-linejoin="round"/><path d="M20 26 L20 32" stroke="#9c6e9a" stroke-width="1.5"/>' },
        { id: 27, theme: 'dusk', num: 'Ⅸ', name_zh: '退潮', name_en: 'EBB', keywords: ['能量低谷','节律','蓄势'], meaning: '海洋退潮是自然节律，\n低谷期无需强行发力。', action: '今天比平时早睡半小时', icon: '<path d="M6 20 Q12 14, 20 14 Q28 14, 34 20" stroke="#9c6e9a" stroke-width="1.5"/><path d="M6 26 Q12 20, 20 20 Q28 20, 34 26" stroke="#9c6e9a" stroke-width="1.5"/>' },
        // 深眠 NIGHT
        { id: 28, theme: 'night', num: 'Ⅰ', name_zh: '月相', name_en: 'MOON', keywords: ['周期变化','暗面','情感潮汐'], meaning: '月有盈亏圆缺，\n情感潮汐也有夜间的秩序。', action: '睡前记录一个念头', icon: '<path d="M24 8 Q14 12, 14 22 Q14 30, 22 32 Q14 30, 12 22 Q12 12, 24 8 Z" stroke="#6a5a9a" stroke-width="1.5" stroke-linejoin="round"/><circle cx="28" cy="14" r="1.5" fill="#6a5a9a"/><circle cx="30" cy="20" r="1" fill="#6a5a9a"/>' },
        { id: 29, theme: 'night', num: 'Ⅱ', name_zh: '入梦', name_en: 'DREAM', keywords: ['潜意识信号','隐喻','解构'], meaning: '梦境编织的意象，\n是潜意识向清醒世界发出的信件。', action: '醒来记下梦的一个画面', icon: '<path d="M20 6 L23 14 L31 14 L25 19 L27 27 L20 22 L13 27 L15 19 L9 14 L17 14 Z" stroke="#6a5a9a" stroke-width="1" stroke-linejoin="round"/><circle cx="20" cy="18" r="2" fill="#6a5a9a"/>' },
        { id: 30, theme: 'night', num: 'Ⅲ', name_zh: '滋养', name_en: 'NURTURE', keywords: ['自我充能','界限','回收'], meaning: '向外输出过多时，\n要把关注的泉水引回内心。', action: '做一件只为自己的事', icon: '<path d="M8 20 Q8 12, 16 12 Q20 12, 20 16 Q20 12, 24 12 Q32 12, 32 20 Q32 28, 20 32 Q8 28, 8 20 Z" stroke="#6a5a9a" stroke-width="1.5" stroke-linejoin="round"/>' },
        { id: 31, theme: 'night', num: 'Ⅳ', name_zh: '潜流', name_en: 'UNDERCURRENT', keywords: ['隐秘情绪','暗流','未察觉'], meaning: '冰封河床之下，\n潜流正以看不见的力量奔涌。', action: '写下"我其实有点…"的句子', icon: '<circle cx="20" cy="20" r="12" stroke="#6a5a9a" stroke-width="1.5" stroke-dasharray="3 3"/><circle cx="20" cy="20" r="4" fill="rgba(106,90,154,0.3)"/>' },
        { id: 32, theme: 'night', num: 'Ⅴ', name_zh: '直觉', name_en: 'INTUITION', keywords: ['身体本能','瞬时判断','无逻辑灵光'], meaning: '未经逻辑演绎的第一反应，\n往往承载身体最真实的记忆。', action: '跟着第一个念头做一个决定', icon: '<circle cx="20" cy="20" r="10" stroke="#6a5a9a" stroke-width="1.5"/><path d="M14 20 Q17 16, 20 20 Q23 24, 26 20" stroke="#6a5a9a" stroke-width="1.5" stroke-linecap="round"/>' },
        { id: 33, theme: 'night', num: 'Ⅵ', name_zh: '独白', name_en: 'SOLILOQUY', keywords: ['真实表达','无观众','卸下伪装'], meaning: '舞台没有观众时，\n真实的叙述才能自由流淌。', action: '写一段不给任何人看的话', icon: '<rect x="10" y="10" width="20" height="20" rx="2" stroke="#6a5a9a" stroke-width="1.5"/><path d="M14 16 L26 16 M14 20 L26 20 M14 24 L22 24" stroke="#6a5a9a" stroke-width="1.5" stroke-linecap="round"/>' },
        { id: 34, theme: 'night', num: 'Ⅶ', name_zh: '深潜', name_en: 'DIVE DEEP', keywords: ['阴影工作','追问底层','直面'], meaning: '水面浅层无法触及处，\n暗底藏着问题的钥匙。', action: '追问自己三次"为什么"', icon: '<path d="M20 6 L20 30 M14 12 L20 6 L26 12" stroke="#6a5a9a" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/><path d="M10 34 L30 34" stroke="#6a5a9a" stroke-width="1.5"/>' },
